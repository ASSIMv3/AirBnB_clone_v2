...
@app.route('/c/<text>')
def c_route(text):
    """Custom C route with 'C is' followed by <text>. Replaces underscores with spaces."""
    return "C is {}".format(text.replace('_', ' '))

@app.route('/python')
@app.route('/python/<text>')
def py_route(text="is cool"):
    """Custom Python route with 'Python is' followed by <text>. Replaces underscores with spaces."""
